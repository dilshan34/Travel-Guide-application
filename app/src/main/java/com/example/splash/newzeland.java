...
public class newzeland extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cur.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                det.setText("New Zealand dollar");
            }
        });
        lan.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                det.setText("English; Māori");
            }
        });
        cap.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                det.setText("Wellington");
            }
        });
    ...
    public void opencities(){
        Intent cities = new Intent(this, cityinnewzealand.class);
